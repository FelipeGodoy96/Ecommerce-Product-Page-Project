  ...
  return (
    ...
    >
      <Box
        ...
        backgroundColor={theme.palette.grayishblue}
      >
        <Typography
          variant="p"
          ...
          fontSize="0.875rem"
          lineHeight="1.25rem"
          backgroundColor={theme.palette.neutral.grayishblue}
          padding="5px"
        >
          {productInfo.vendor}
        </Typography>
      ...
      <Box
        ...
        sx={{ marginTop: "10%", marginBottom: "10%", width: "100%" }}
      >
        <Typography
          variant="h4"
          fontWeight="700"
      ...
      >
        <Typography variant="p" sx={{ fontSize: "1.5rem", fontWeight: "700" }}>
          $
          {(parseFloat(productInfo.price * (productInfo.discount / 100)) * quantity).toFixed(
            2
          )}
        </Typography>
        <span
      ...
      <Box
        ...
        sx={{ marginTop: "10%", display: "flex", flexDirection: "row" }}
      >
        <Box
          sx={{
            gap: "20px",
